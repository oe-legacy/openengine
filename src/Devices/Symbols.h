...
// Copied from the SDL SDL_keysym.h that in turn uses X11 keysym.h
// -------------------------------------------------------------------
 ...
 * We'll follow in the footsteps of X11/SDL. No uppercase letters are
 * used. Check with KEY_MOD_SHIFT for that. Keys map directly to ASCII.
 *
 * @enum Key
 */
typedef enum {
...
typedef enum {
	...
	//Meta modifiers (or'd from KeyMod enum)
	KEY_MOD_CTRL	  = 0x00C0, //KEY_MOD_LCTRL|KEY_MOD_RCTRL
	KEY_MOD_SHIFT     = 0x0003, //KEY_MOD_LSHIFT|KEY_MOD_RSHIFT
	KEY_MOD_ALT       = 0x0300, //KEY_MOD_LALT|KEY_MOD_RALT
	KEY_MOD_META      = 0x0C00  //KEY_MOD_LMETA|KEY_MOD_RMETA
} KeyMod;
