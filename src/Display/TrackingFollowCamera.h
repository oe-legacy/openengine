...
#ifndef _TRACKING_FOLLOW_CAMERA_H_
#define _TRACKING_FOLLOW_CAMERA_H_
 ...
 * camera.
 *
 * TrackingFollowCamera usage:
 * @code
 * // create camera with an existing viewing volume.
 * cam = new TrackingFollowCamera(*volume);
 *
 ...
 * @endcode
 *
 * @class TrackingFollowCamera TrackingFollowCamera.h Display/TrackingFollowCamera.h
 */
class TrackingFollowCamera : public Camera {
...
public:
    ...
    TrackingFollowCamera(IViewingVolume& volume);
    virtual ~TrackingFollowCamera();
    ...
    // New tracking/follow cam methods
...
#endif // _TRACKING_FOLLOW_CAMERA_H_
