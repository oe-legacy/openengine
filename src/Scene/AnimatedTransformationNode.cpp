...
AnimatedTransformationNode::AnimatedTransformationNode() : animTrans(NULL) {
}

AnimatedTransformationNode::AnimatedTransformationNode(AnimatedTransformation* animTrans) : animTrans(animTrans){
}
